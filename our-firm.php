                ...
                <nav class="navbar navbar-expand-lg bg-primary navbar-primary p-0 float-right ">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarCollapse">
                        <div class="navbar-nav mr-auto py-0 bg-primary">
                            ...
                            <a href="our-firm.php" class="nav-item nav-link active">Our Firm </a>
    ...
    <div class="container-fluid bg-page-header" style="margin-bottom: 40px;">
        <div class="container">
            <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 400px">
                <h3 class="display-3 text-white text-uppercase">Our Firm</h3>
                <div class="d-inline-flex text-white">
                    <p class="m-0 text-uppercase"><a class="text-white" href="index.php">Home</a></p>
                    <i class="fa fa-angle-double-right pt-1 px-3"></i>
                    <p class="m-0 text-uppercase">Our Firm</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-fluid py-2">
        <div class="container py-2">
            <div class="row py-1">
                ...
                <div class="col-lg-8 mt-4 mt-lg-0 p-1" style="border-right: 10px solid #114C5E;">
                    <h6 class="text-uppercase text-center" style="color: #124B5E;">Welcome to MEN Advocates </h6>
                    <hr>
                    <h3 class="mb-2 text-center" style="color: #124B5E;">WHO WE ARE</h3>
                    ...
                    <p class="text-center">We at Njigina Macharia Advocates (MEN Advocates) strive to consistently break new frontiers. This is not just in how we run our practice but in our areas of focus. We work tirelessly to provide and deliver solutions to our clients in areas that anything but traditional.</p>
                    <h3 class="mb-2 text-center" style="color: #124B5E;">OUR COMMITMENT </h3>
                    <p class="text-center">We pride ourselves in building a lasting relationship with our clients. We are commercially astute. So, therefore our clients can expect legal advice coupled with business acumen. Even when the law is uncertain, we never lose sight of the desired business outcome.</p>
                    <p class="text-center">We are not afraid to push boundaries when it comes to thinking. We are curious about the world, the law and intellectually fearless. Our lawyers share this desire for learning about the law and business because we believe that being more informed makes us better thinkers and lawyers.</p>
                    <hr>
                    <a href="contact.php" class="btn btn-light mt-2" style="border: 2px solid #114C5E; color:#114C5E">GET IN TOUCH WITH US TODAY</a>
                    
                </div>
                <div class="col-lg-4 text-center" >
                    
                        <img class="img-fluid rounded" src="img/logo4.png" alt="" style="margin-top:150px; height:100px; ">
